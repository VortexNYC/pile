...
5. **Agent/AI surfaces** — Linear has agent sessions, activities, skills, and AI conversations. Vortex has none yet.
...
| **Users & memberships**               | `users`, `teams/members`, `userUpdate`, `organization`                                                                                                                  | Partial       | `user`, `session`, `account` tables; `workspaceMemberships` with `owner/admin/member`. No team-level memberships or invites.                                                     |
| **Teams**                             | `teams`, `teamCreate`, `teamUpdate`, `teamDelete`, `teamMemberships`, `teamSettings`                                                                                    | Missing       | Vortex uses workspaces as the only grouping. Multi-team orgs not modeled.                                                                                                        |
...
| **Agent / AI surfaces**               | `agentSessions`, `agentActivities`, `agentSkills`, `aiConversation*`, `prompt*`                                                                                         | Missing       | Not modeled.                                                                                                                                                                     |
...
6. **Agent session/activity API** — Linear's first-class agent surface is not mirrored.
7. **Published docs / SDK / CLI** — the API is OpenAPI-first but lacks a docs site and a full CLI.
...
6. **Agent sessions and activities API** — agent-native parity.
