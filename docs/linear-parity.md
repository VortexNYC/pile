...
| **Projects**                          | `projects`, `projectCreate`, `projectUpdate`, `projectArchive`, `projectUpdateReminder`, `projectStatus`                                                                | Partial                                                                         | `projects` table + CRUD; `project_updates`, `project_milestones`, `project_update_reminders` with full CRUD. No `projectArchive` yet.                                                                                                                       |
