...
| **Comments**                          | `comment`, `comments`, `commentCreate`, `commentUpdate`, `commentDelete`, `commentResolve`, `commentUnresolve`, `reactions`                                             | Partial                                                                         | CRUD for issue/PR comments, reactions on issues and comments. No `resolve`/`unresolve` threads.                                                                                                            |
...
| **Documents**                         | `documents`, `documentCreate/Update/Delete`, `documentContentHistory`                                                                                                   | Done                                                                            | `documents` + `document_content_history` in the workspace DO; BlockNote JSON content, project/issue/initiative/parent linkage, trash/restore, history. |                                                                                                                                                                                               |
...
Vortex currently exposes **103 OpenAPI paths / 163 MCP tools**. Linear's public GraphQL surface has **626 root operations** (170 + 374 + 82), so Vortex covers the high-frequency subset but not the long tail.
