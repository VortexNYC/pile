...
|                                       | **Agent / AI surfaces**                                                                                                                                                 | `agentSessions`, `agentActivities`, `agentSkills`, `aiConversation*`, `prompt*` | Partial                                                                                                                                                                                                    | `agent_sessions`/`agent_activities` in the workspace DO; `agent_skills` registry with HTTP invoke; `agent_conversations`/`agent_messages` for agent/human threads. No push transport, OAuth apps, or full skill orchestration yet. |
